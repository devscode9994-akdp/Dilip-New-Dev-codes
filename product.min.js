if (!customElements.get('variant-selects')) {
    ...
    class VariantSelects extends HTMLElement {
        ...
        onVariantChange() {
            ...
            let carousalElement = this.closest('.thb-product-detail');
            let isCarousal = carousalElement?.dataset.productScroll === "true";
...
// Fabric and Finish color swatches hover preview image code

document.querySelectorAll('.swatch-and-name-container').forEach(item => {

    item.addEventListener('mouseenter', () => {
        // lower all swatches
        document.querySelectorAll('.swatch-and-name-container').forEach(el => {
            el.style.zIndex = "1";
            el.style.position = "relative";
        });

        // raise only hovered one
